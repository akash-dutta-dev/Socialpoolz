       ...
       <script>
		...
		<div class="profile_left_options">
            ...
            <ul class="question_left_panel_ul">
				<a href="profile.php?profile_username=<?php echo $user_to_show; ?>"> <li class="question_left_panel_li question_tablinks question_activ" >Answers</li></a>
				...
				<a href="profile_following.php?profile_username=<?php echo $user_to_show; ?>"><li class="question_left_panel_li question_tablinks" style="color:#6da5ff;">Followings</li></a>
		...
		<div class='profile_feed'>
				...
				<?php 
					if(($user_to_show != $userLoggedIn) && $user['following']==0 ){
						echo '<h5><b>'.$user['first_name'].', does\'nt follow anyone yet.</b></h5>';
					}
					else{
		...
		<script>
			...
			$(document).ready(function() {
				...
				$.ajax({
					url: "ajaxfile/ajax_if_getProfileFollowing.php",
					type: "POST",
					data: "page=1&userLoggedIn=" + userLoggedIn + "&user_to_show=" + user_to_show,
					cache:false,
				...
				$(window).scroll(function() {
					...
					if ((document.body.scrollHeight == document.body.scrollTop + window.innerHeight) && noMorePosts == 'false') {
						...
						var ajaxReq = $.ajax({
							url: "ajaxfile/ajax_if_getProfileFollowing.php",
							type: "POST",
							data: "page=" + page + "&userLoggedIn=" + userLoggedIn + "&user_to_show=" + user_to_show,
							cache:false,
