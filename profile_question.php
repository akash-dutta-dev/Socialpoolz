       ...
       <script>
		...
		<div class="profile_left_options">
            ...
            <ul class="question_left_panel_ul">
                ...
                <a href="profile_question.php?profile_username=<?php echo $user_to_show; ?>"><li class="question_left_panel_li question_tablinks" style="color:#6da5ff;">Question</li></a>
		...
		<div class='profile_feed'>
				...
				<?php 
					if(($user_to_show != $userLoggedIn) && $user['question']==0 ){
						echo '<h5><b>'.$user['first_name'].', did not ask any question till now</b></h5>';
					}
					else{
		...
		<script>
			...
			$(document).ready(function() {
				...
				$.ajax({
					url: "ajaxfile/ajax_if_getProfileQuestion.php",
					type: "POST",
