...
?>
		...
		<div class="main_body">
		   <div class="question_left_panel">
				...
				<ul class="question_left_panel_ul">
					...
					<a href="likedQuestion.php"><li class="question_left_panel_li question_tablinks" style="color:#6da5ff;" >Liked Question</li></a>
			...
			<div class="question_main main_colum">
				...
				<div id="LikedQuestion" class="question_tabcontent">
		...
		<script>
			...
			$(document).ready(function() {
				...
				$.ajax({
					url: "ajaxfile/ajax_if_getLikedQuestion.php",
					type: "POST",
