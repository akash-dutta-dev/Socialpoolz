...
?>
		...
		<div class="main_body">
			<div class="question_left_panel">
				...
				<ul class="question_left_panel_ul">
					...
					<a href="answerLater.php"><li class="question_left_panel_li question_tablinks" style="color:#6da5ff;">Answer Later</li></a>
					...
					<a href="draft.php"><li class="question_left_panel_li question_tablinks">Draft</li></a>
				</ul>

			</div>

			<div class="question_main main_colum">           
				<div id="AllQuestion" class="question_tabcontent" style="display:block;">

					  <?php                   
					   //$que_ob=new Post($con,$userLoggedIn);
					   //$que_ob->getAnswerLater();
					  ?> 
		...
		<script>
			...
			$(document).ready(function() {
				...
				$.ajax({
					url: "ajaxfile/ajax_if_getAnswerLater.php",
					type: "POST",
