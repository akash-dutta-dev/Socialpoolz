...
?>
		...
		<div class="main_body">
			<div class="question_left_panel">
				...
				<ul class="question_left_panel_ul">
					<a href="question.php"> <li class="question_left_panel_li question_tablinks question_activ" style="color:#6da5ff;">All Question</li></a>
		...
		<script>
			...
			$(document).ready(function() {
				...
				$.ajax({
					url: "ajaxfile/ajax_if_getQuestion.php",
					type: "POST",
