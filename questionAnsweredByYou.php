		...
		<div class="main_body">
			...
			<div class="question_left_panel">
				...
				<ul class="question_left_panel_ul">
					...
					<a href="questionAnsweredByYou.php"><li class="question_left_panel_li question_tablinks" style="color:#6da5ff;">Question answered by you</li></a>
			...
			<div class="question_main main_colum">         
				...
				<div id="QuestionAnsweredByYou" class="question_tabcontent">
