       ...
       <script>
		...
		<div class="profile_left_options">
            ...
            <ul class="question_left_panel_ul">
				...
				<a href="profile_topics.php?profile_username=<?php echo $user_to_show; ?>"><li class="question_left_panel_li question_tablinks" style="color:#6da5ff;">Topics</li></a>
            </ul>
		</div>
		...
		<div class='profile_feed'>
				...
				<?php 
					if(($user_to_show != $userLoggedIn) && $user['topic']==',' ){
						echo '<h5><b>'.$user['first_name'].', does\'nt follow any topic yet.</b></h5>';
					}
					else{
		...
		<script>
			...
			$(document).ready(function() {
				...
				$.ajax({
					url: "ajaxfile/ajax_if_getProfileTopic.php",
					type: "POST",
