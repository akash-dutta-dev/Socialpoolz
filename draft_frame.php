...
<body onload="initDoc();">
  <?php  
   ...
   ?>
	...
	<?php  
	//Get id of post
	if(isset($_GET['question_id']) && isset($_GET['draft_id'])) {
		$question_id = $_GET['question_id'];
		$draft_id = $_GET['draft_id'];
		$data_query = mysqli_query($con, "SELECT * FROM draft WHERE id='$draft_id' ORDER BY id DESC");
		$question_draft_row = mysqli_fetch_array($data_query);
		$a_body = $question_draft_row['answer_body'];
	}
/*
...
-->
				...
				<div id="textBox" contenteditable="true" placeholder="Enter your text here"><?php echo $a_body; ?></div>
